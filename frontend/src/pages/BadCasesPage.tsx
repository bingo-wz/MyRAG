...
import type { BadCase, KnowledgeDraftSeed } from '../types'

export function BadCasesPage({ onCreateKnowledge }: { onCreateKnowledge: (seed: KnowledgeDraftSeed) => void }) {
